...
const circle =
  '<p class="sign circle text-shadow-win"><i class="fa-regular fa-circle "></i></p>'
const cross =
  '<p class="sign cross text-shadow-win"><i class="fa-solid fa-x"></i></p>'
...
playBtnOne.addEventListener('click', hidderBtnTwo)
playBtnTwo.addEventListener('click', hidderBtnOne)
...
function whoWin() {
  ...
  if (
    gamePlace[0].classList.contains('circle') &&
    gamePlace[1].classList.contains('circle') &&
    gamePlace[2].classList.contains('circle')
  ) {
    //circleWinOne
    ...
    gamePlace[3].classList.contains('circle') &&
    gamePlace[4].classList.contains('circle') &&
    gamePlace[5].classList.contains('circle')
  ) {
    //circleWinTwo
    ...
    gamePlace[6].classList.contains('circle') &&
    gamePlace[7].classList.contains('circle') &&
    gamePlace[8].classList.contains('circle')
  ) {
    //circleWinThree
  ...
  //Cross Win
    ...
    gamePlace[0].classList.contains('cross') &&
    gamePlace[1].classList.contains('cross') &&
    gamePlace[2].classList.contains('cross')
  ) {
    //circleWinOne
    gamePlace[0].classList.add('background-win')
    gamePlace[1].classList.add('background-win')
    ...
    gamePlace[3].classList.contains('cross') &&
    gamePlace[4].classList.contains('cross') &&
    gamePlace[5].classList.contains('cross')
  ) {
    //circleWinTwo
    gamePlace[3].classList.add('background-win')
    gamePlace[4].classList.add('background-win')
    ...
    gamePlace[6].classList.contains('cross') &&
    gamePlace[7].classList.contains('cross') &&
    gamePlace[8].classList.contains('cross')
  ) {
    //circleWinThree
    gamePlace[6].classList.add('background-win')
    gamePlace[7].classList.add('background-win')
